...
namespace FellowOakDicom.Network
{
    ...
    public class DefaultDicomServerFactory : IDicomServerFactory
    {
        ...
        public IDicomServer Create<T>(string ipAddress, int port, ITlsAcceptor tlsAcceptor = null, Encoding fallbackEncoding = null, Logger logger = null, object userState = null) where T : DicomService, IDicomServiceProvider
