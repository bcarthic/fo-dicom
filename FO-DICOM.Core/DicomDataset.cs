...
namespace FellowOakDicom
{
    ...
    public partial class DicomDataset : IEnumerable<DicomItem>
    {
        ...
        {
            return this.TryGetValues<string>(DicomTag.SpecificCharacterSet, out var charsets)
        ...
        public T GetDicomItem<T>(DicomTag tag) where T : DicomItem
            => DicomDatasetGetterExtensions.GetDicomItem<T>(this, tag);
        ...
        public DicomSequence GetSequence(DicomTag tag)
            => DicomDatasetGetterExtensions.GetSequence(this, tag);


        public DicomCodeItem GetCodeItem(DicomTag tag)
            => DicomDatasetGetterExtensions.GetCodeItem(this, tag);


        public DicomMeasuredValue GetMeasuredValue(DicomTag tag)
            => DicomDatasetGetterExtensions.GetMeasuredValue(this, tag);


        public DicomReferencedSOP GetReferencedSOP(DicomTag tag)
            => DicomDatasetGetterExtensions.GetReferencedSOP(this, tag);
        ...
        public bool TryGetSequence(DicomTag tag, out DicomSequence sequence)
            => DicomDatasetGetterExtensions.TryGetSequence(this, tag, out sequence);
        ...
        public bool TryGetNonEmptySequence(DicomTag tag, out DicomSequence sequence)
            => DicomDatasetGetterExtensions.TryGetNonEmptySequence(this, tag, out sequence);
        ...
        public int GetValueCount(DicomTag tag)
            => DicomDatasetGetterExtensions.GetValueCount(this, tag);
        ...
        public T GetValue<T>(DicomTag tag, int index)
            => DicomDatasetGetterExtensions.GetValue<T>(this, tag, index);
        ...
        public bool TryGetValue<T>(DicomTag tag, int index, out T elementValue)
            => DicomDatasetGetterExtensions.TryGetValue(this, tag, index, out elementValue);
        ...
        public T GetValueOrDefault<T>(DicomTag tag, int index, T defaultValue)
            => DicomDatasetGetterExtensions.GetValueOrDefault(this, tag, index, defaultValue);
        ...
        public T[] GetValues<T>(DicomTag tag)
            => DicomDatasetGetterExtensions.GetValues<T>(this, tag);
        ...
        public bool TryGetValues<T>(DicomTag tag, out T[] values)
            => DicomDatasetGetterExtensions.TryGetValues(this, tag, out values);
        ...
        public T GetSingleValue<T>(DicomTag tag)
            => DicomDatasetGetterExtensions.GetSingleValue<T>(this, tag);
        ...
        public bool TryGetSingleValue<T>(DicomTag tag, out T value)
            => DicomDatasetGetterExtensions.TryGetSingleValue<T>(this, tag, out value);
        ...
        public T GetSingleValueOrDefault<T>(DicomTag tag, T defaultValue)
            => DicomDatasetGetterExtensions.GetSingleValueOrDefault(this, tag, defaultValue);
        ...
        public string GetString(DicomTag tag)
            => DicomDatasetGetterExtensions.GetString(this, tag);
        ...
        public bool TryGetString(DicomTag tag, out string stringValue)
            => DicomDatasetGetterExtensions.TryGetString(this, tag, out stringValue);
        ...
        internal DicomTag GetPrivateTag(DicomTag tag, bool createTag)
            => DicomDatasetGetterExtensions.GetPrivateTag(this, tag, createTag);
        ...
        public bool Contains(DicomTag tag)
            => DicomDatasetGetterExtensions.Contains(this, tag);


        public IEnumerable<DicomItem> FunctionalGroupValues(int frame)
        {
            // gets all items from SharedfunctionalGroup 
            if (this.TryGetSequence(DicomTag.SharedFunctionalGroupsSequence, out var sharedFunctionalGroupsSequence))
            {
            ...
            if (this.TryGetSequence(DicomTag.PerFrameFunctionalGroupsSequence, out var perFrameFunctionalGroupsSequence)
                && perFrameFunctionalGroupsSequence.Count() > frame)
            {
        ...
        public DicomDataset CopyTo(DicomDataset destination, params DicomTag[] tags)
        {
            if (destination != null)
            {
                ...
                {
                    destination.AddOrUpdate(this.GetDicomItem<DicomItem>(tag));
                }
            }
            return this;
        }
        ...
        {
            return this.GetPrivateTag(tag, true);
        }
